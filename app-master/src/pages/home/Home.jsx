...
const [products] = useState([
    ...
    { id: 32, name: "Solar Panel", price: 75.00, category: "solarpanel", color: "green", date: "2025-12-04", img: "solar-panel-04.jpg" },
  ]);
                            ...
                            <div className="p-l-25 p-r-30 p-lr-0-lg">
                                <div className="wrap-slick3 flex-sb flex-w">
                                    ...
                                    <div className="slick3 gallery-lb">
                                        <div className="item-slick3" data-thumb="images/solar-structure-01.jpg">
                                        ...
                                        <div className="item-slick3" data-thumb="images/solar-structure-02.jpg">
                                            <div className="wrap-pic-w pos-relative">
                                        ...
                                        <div className="item-slick3" data-thumb="images/solar-structure-03.jpg">
                                            <div className="wrap-pic-w pos-relative">
