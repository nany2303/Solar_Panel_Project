				...
				<span className="mtext-103 cl2">
                    ...
                    <div className="header-cart-content flex-w js-pscroll">
                        <ul className="header-cart-wrapitem w-full">
                            ...
                            <li className="header-cart-item flex-w flex-t m-b-12">
                                <div className="header-cart-item-img">
                                    <img src="/images/solar--03.jpg" alt="IMG" />
                                </div>
                ...
                <div className="container">
                    <div className="flex-w flex-sb-m p-b-52">
                        <div className="flex-w flex-l-m filter-tope-group m-tb-10">
                            ...
                            <button className="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".solarpanel">
                                Solar Panel
                            </button>

                            <button className="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".solarwaterheater">
                                Solar Water Heater
                            </button>

                            <button className="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".solarpanelstructure">
                                Solar Panel Structure
                            </button>

                            <button className="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".streetlight">
                                Street Light
                            </button>
                        </div>
                    ...
                    <div className="row isotope-grid">
                        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item solar panels">
                            {/* Block2 */}
